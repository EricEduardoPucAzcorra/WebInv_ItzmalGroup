...
@section('title', 'Almacenes de lavado')

@section('contenido')



<div id="AlmacenL" v-cloak>
<!--     <p>@{{prueba}}</p> -->
        ...
        <div class="card-body">
         <!--    <form> -->
             ...
             <!--    <legend></legend> -->
                ...
                <button  class="btn btn-primary" @click="GuardarAlmacenL()" v-if="submit==true">Guadar</button>
                <button  class="btn btn-info" @click="ActualizarAlmacenL()" v-if="submit==false">Actulizar</button>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr v-for="almacenL in AlmacenLav" >
                      <td >@{{almacenL.id_AlmacenLavado}}</td>
                      <td>@{{almacenL.nombre}}</td>
                      <td><span class="tag tag-success">@{{almacenL.ubicacion}}</span></td>
                      <td><button class="btn btn-info btn-sm" @click="EditarAlmacenL(almacenL.id_AlmacenLavado)"><i class="fas fa-edit"></i></button> 
                        <button class="btn btn-danger btn-sm" @click="EliminarAlmacenL(almacenL.id_AlmacenLavado)"><i class="fas fa-trash-alt"></i></button></td>
                    </tr>  
...
@push('js')
 ...
 <script type="text/javascript" src="{{asset('js/apis/almacenes/apiAlmacenLavanderia.js')}}"></script>
@endpush
