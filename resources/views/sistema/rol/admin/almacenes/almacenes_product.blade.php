...
@section('title', 'Almacenes de productos')

@section('contenido')

<div id="AlmacenP" v-cloak>
<!--     <p>@{{prueba}}</p> -->
...
<div class="col-12">
    <div>
        <button class=" d-sm-inline-block btn btn-sm btn-primary shadow-sm" @click="NuevoAlmacenP()" v-if="form==true">Nuevo</button> 
        ...
        <div class="card-body">
         <!--    <form> -->
             ...
             <!--    <legend></legend> -->
                ...
                <button  class="btn btn-primary" @click="GuardarAlmacen()" v-if="submit==true">Guadar</button>
                <button  class="btn btn-info" @click="ActualizarAlmacenP()" v-if="submit==false">Actulizar</button>
                <button  class="btn btn-danger" @click="cancelarP()">Cancelar</button>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr v-for="almacenP in AlmacenesP" >
                      <td >@{{almacenP.id_almacenPro}}</td>
                      <td>@{{almacenP.nombre}}</td>
                      <td><span class="tag tag-success">@{{almacenP.ubicacion}}</span></td>
                      <td><button class="btn btn-info btn-sm" @click="EditarAlmacenP(almacenP.id_almacenPro)"><i class="fas fa-edit"></i></button> 
                        <button class="btn btn-danger btn-sm" @click="eliminarAlmacenP(almacenP.id_almacenPro)"><i class="fas fa-trash-alt"></i></button></td>
                    </tr>  
...
@push('js')
 ...
 <script type="text/javascript" src="{{asset('js/apis/almacenes/apiAlmacenProducto.js')}}"></script>
@endpush
