...
@section('title', 'Almacenes de recursos huespedes')

@section('contenido')

<div id="almacenH" v-cloak>
    <!-- <p>@{{prueba}}</p> -->
        ...
        <div class="card-body">
         <!--    <form> -->
             ...
             <!--    <legend></legend> -->
                ...
                <button  class="btn btn-primary" @click="RegistrarAlmacenH()" v-if="submit==true">Guadar</button>
                <button  class="btn btn-info" @click="ActualizarAlmacenH()" v-if="submit==false">Actulizar</button>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr v-for="almacenH in almacenesH" >
                      <td >@{{almacenH.id_AlmacenRHuesped}}</td>
                      <td>@{{almacenH.nombre}}</td>
                      <td><span class="tag tag-success">@{{almacenH.ubicacion}}</span></td>
                      <td><button class="btn btn-info btn-sm" @click="EditarAlmacenH(almacenH.id_AlmacenRHuesped)"><i class="fas fa-edit"></i></button> 
                        <button class="btn btn-danger btn-sm" @click="eliminarAlmacenH(almacenH.id_AlmacenRHuesped)"><i class="fas fa-trash-alt"></i></button></td>
                    </tr>  
...
@push('js')
 ...
 <script type="text/javascript" src="{{asset('js/apis/almacenes/apiAlmacenHuesped.js')}}"></script>
@endpush
